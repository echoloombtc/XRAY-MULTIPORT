...
# ==================================================
# Link Hosting Kalian
fisabiliyusri="raw.githubusercontent.com/kenDevXD/XRAY-MULTIPORT/main/wireguard"
...
wget -O addwg "https://raw.githubusercontent.com/kenDevXD/XRAY-MULTIPORT/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/kenDevXD/XRAY-MULTIPORT/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/kenDevXD/XRAY-MULTIPORT/main/wireguard/renewwg.sh"
chmod +x menuwg
chmod +x addwg
chmod +x delwg
chmod +x renewwg
